...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_question_mark_means_optional
    # searches first charater of ab? i.e. a. matches then returns from a.
    # "abbccc az"[/az?/] => "a"
    # "abbccc az"[/b?/] => "" # can't find b in 1st position hence returns ""
    # "abbccc az"[/a?/] => "a" # finds a in 1st position hence returns "a"
    # "abbccc az"[/ az?/] => " az" # finds 1st occurrence of " " and returns from there
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Answer
    # "when would * fail to match" is "never".
  end
